...
const availabilityData: Record<string, Record<TimeSlot, boolean>> = {
  ...
  '2025-11-28': { '8:00 AM': false, '11:00 AM': false, '3:00 PM': false, '5:00 PM': false },
  ...
  '2025-12-15': { '8:00 AM': false, '11:00 AM': false, '3:00 PM': false, '5:00 PM': false },
  '2025-12-20': { '8:00 AM': true, '11:00 AM': false, '3:00 PM': true, '5:00 PM': true },
  '2025-12-24': { '8:00 AM': false, '11:00 AM': true, '3:00 PM': false, '5:00 PM': false },
  '2025-12-25': { '8:00 AM': false, '11:00 AM': false, '3:00 PM': false, '5:00 PM': false },
...
export default function VendorReservas() {
  ...
  useEffect(() => {
    ...
    try {
      const parsed = JSON.parse(vendorData) as VendorSession;
      setVendor(parsed);
    } catch {
  ...
  // Si no hay vendor, no renderizar nada (se redirige)
  ...
  return (
    <main className="min-h-screen overflow-hidden relative">
      ...
      {/* Header */}
      <header className="relative z-20 bg-black/80 backdrop-blur-xl border-b border-white/10">
          ...
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center gap-4">
              ...
              <button
                ...
                className="px-3 py-1.5 text-xs font-medium text-white/70 hover:text-red-400 bg-white/5 hover:bg-red-500/10 border border-white/10 hover:border-red-500/30 rounded-lg transition-all"
              >
                Cerrar Sesión
              </button>
            </div>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="text-center mb-6">
            <h1 className="text-2xl md:text-3xl font-bold text-white mb-1">
              Reservas Skyline Canopy Tour
            </h1>
            <p className="text-[#E6BE4D]">{vendor.nombre}</p>
          </div>
