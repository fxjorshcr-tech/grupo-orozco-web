    ...
    <main className="min-h-screen overflow-hidden relative">
            ...
            <div className="hidden md:flex items-center space-x-1">
              {['Inicio', 'Parques', 'OrostudiosCR', 'Nosotros', 'Contacto'].map((item, i) => (
                <a
                  ...
                  className="px-4 py-2 text-white/80 hover:text-[#E6BE4D] hover:bg-white/10 rounded-full transition-all duration-300 text-sm font-medium"
                >
                  {item}
                </a>
              ))}
      ...
      <section id="inicio" className="relative z-10 min-h-screen flex items-center justify-center px-4 pt-20">
        <div className="relative z-10 text-center max-w-5xl mx-auto">
          ...
          <p className="text-lg text-[#E6BE4D]/70 mb-12">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              href="#parques"
              className="bg-gradient-to-r from-[#996515] via-[#C9A227] to-[#E6BE4D] hover:shadow-lg hover:shadow-[#C9A227]/40 group inline-flex items-center justify-center gap-2 px-8 py-4 text-slate-950 font-semibold rounded-2xl"
            >
              Nuestros Parques
            ...
            <a
              href="#orostudios"
              className="inline-flex items-center justify-center px-8 py-4 bg-white/10 backdrop-blur-sm text-white font-semibold rounded-2xl border border-[#C9A227]/30 hover:bg-[#C9A227]/10 hover:border-[#C9A227]/50 transition-all duration-300"
            >
              OrostudiosCR
            </a>
          </div>
      ...
      <section className="relative z-10 py-32 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <span className="bg-[#C9A227]/20 text-[#E6BE4D] border border-[#C9A227]/30 inline-block px-4 py-1.5 rounded-full text-sm font-medium mb-4">
              Lo que hacemos
            </span>
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            {/* Card Parques */}
            <div className="group relative p-8 bg-white/5 backdrop-blur-xl rounded-3xl border border-white/10 hover:border-[#C9A227]/50">
              ...
              <div className="relative">
                ...
                <h3 className="text-2xl font-bold text-white mb-3">Parques de Aventura</h3>
            ...
            <div className="group relative p-8 bg-white/5 backdrop-blur-xl rounded-3xl border border-white/10 hover:border-[#C9A227]/50">
              ...
              <div className="relative">
                ...
                <h3 className="text-2xl font-bold text-white mb-3">Contenido Fotográfico</h3>
                <p className="text-white/60 leading-relaxed">
      ...
      <section id="parques" className="relative z-10 py-32 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <span className="bg-[#C9A227]/20 text-[#E6BE4D] border border-[#C9A227]/30 inline-block px-4 py-1.5 rounded-full text-sm font-medium mb-4">
              Administración
            ...
            {parquesAdministrados.map((parque, index) => (
              ...
              >
                ...
                <div className="relative p-6">
                  <span className="bg-[#C9A227]/20 text-[#E6BE4D] border border-[#C9A227]/30 inline-block px-3 py-1 text-xs font-medium rounded-full mb-3">
                    {parque.categoria}
                  </span>
                  ...
                  {!parque.proximamente ? (
                    <Link
                      href={parque.url}
                      target="_blank"
                      className="text-[#E6BE4D] hover:text-[#FFD966] inline-flex items-center font-medium group/link"
                    >
                      Visitar sitio web
      ...
      <section id="orostudios" className="relative z-10 py-32 px-4">
        {/* Background accent */}
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center mb-20">
            ...
            <div>
              ...
              <div className="grid grid-cols-3 gap-4 mb-8">
                {[
                  ...
                  <div key={i} className="text-center p-4 bg-white/5 backdrop-blur-sm rounded-2xl border border-white/10">
                    <div className="text-[#E6BE4D] text-2xl md:text-3xl font-bold">
                      {stat.value}
                    </div>
              ...
              <Link
                ...
                target="_blank"
                className="bg-gradient-to-r from-[#996515] via-[#C9A227] to-[#E6BE4D] hover:shadow-lg hover:shadow-[#C9A227]/40 inline-flex items-center gap-2 px-6 py-3 text-slate-950 font-semibold rounded-xl"
              >
                Conocer más
            ...
            <div className="relative">
              <div className="relative h-80 bg-white/5 backdrop-blur-xl rounded-3xl border border-white/10 flex items-center justify-center p-8 overflow-hidden hover:border-[#C9A227]/50">
      ...
      <section id="sobre" className="relative z-10 py-32 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="relative p-8 md:p-12 bg-white/5 backdrop-blur-xl rounded-3xl border border-white/10 hover:border-[#C9A227]/50">
            ...
            <div className="relative space-y-6 text-lg text-white/70 leading-relaxed">
              <p>
                Somos un grupo empresarial costarricense con <span className="text-white font-semibold">más de 20 años de experiencia</span>, especializado en la administración de parques de aventura y contenido fotográfico profesional para el sector turístico.
              </p>
              <p>
                Nuestro portafolio incluye operaciones en ubicaciones estratégicas como <span className="text-[#E6BE4D]">La Fortuna</span> y <span className="text-[#E6BE4D]">Santa Cruz</span>, donde miles de visitantes experimentan la emoción del canopy tour. Para 2026, inauguraremos nuestro tercer parque cerca del Volcán Poás.
              </p>
              <p>
                A través de <span className="text-white font-semibold">OrostudiosCR</span>, hemos revolucionado la fotografía turística en Costa Rica con un modelo único que beneficia tanto a los parques como a sus visitantes.
              </p>
              <p>
                Nuestro compromiso: crear <span className="text-[#E6BE4D] font-semibold">valor sostenible</span> para nuestras comunidades, preservar el medio ambiente y superar las expectativas de cada cliente.
              </p>
            </div>
          </div>
        </div>
      ...
      <footer id="contacto" className="relative z-10 border-t border-white/10 py-16 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-4 gap-8 mb-12">
            ...
            <div>
              <h3 className="text-sm font-semibold text-white uppercase tracking-wider mb-4">Empresas</h3>
              <ul className="space-y-2 text-sm">
                <li>
                  <a href="https://www.skylinecanopytour.com" target="_blank" className="text-[#E6BE4D] hover:text-[#FFD966]">
                    Skyline Canopy Tour
                  </a>
                </li>
                <li>
                  <a href="https://www.arenalecoglide.com" target="_blank" className="text-[#E6BE4D] hover:text-[#FFD966]">
                ...
                <li>
                  <a href="https://www.orostudioscr.com" target="_blank" className="text-[#E6BE4D] hover:text-[#FFD966]">
                    OrostudiosCR
                  </a>
                </li>
              </ul>
            ...
            <div>
              <h3 className="text-sm font-semibold text-white uppercase tracking-wider mb-4">Ubicaciones</h3>
