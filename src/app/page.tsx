          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            <div className="group relative p-8 bg-white/5 backdrop-blur-xl rounded-3xl border border-white/10 hover:border-[#C9A227]/50 transition-all duration-500">
              ...
              <div className="relative">
                ...
                <h3 className="text-2xl font-black text-white mb-3">Parques de Aventura</h3>
            ...
            <div className="group relative p-8 bg-white/5 backdrop-blur-xl rounded-3xl border border-white/10 hover:border-[#C9A227]/50 transition-all duration-500">
              ...
              <div className="relative">
                ...
                <h3 className="text-2xl font-black text-white mb-3">Contenido Fotográfico</h3>
                <p className="text-white/60 leading-relaxed">
      ...
      <footer id="contacto" className="relative z-10 border-t border-white/10 py-16 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-4 gap-8 mb-12">
            ...
            <div>
              <h3 className="text-sm font-black text-white uppercase tracking-wider mb-4">Contacto</h3>
              <p className="text-white/50 text-sm mb-2">gabrielorozco@grupooroz.com</p>
              <p className="text-white/50 text-sm">+506 6098 2244</p>
            </div>
            <div>
              <h3 className="text-sm font-black text-white uppercase tracking-wider mb-4">Empresas</h3>
            ...
            <div>
              <h3 className="text-sm font-black text-white uppercase tracking-wider mb-4">Ubicaciones</h3>
